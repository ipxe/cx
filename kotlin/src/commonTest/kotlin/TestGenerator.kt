...
class GeneratorTest {
    ...
    fun specTest(type: GeneratorType, seed: UByteArray, first: String,
                 count: Int, last: String) {
    ...
    @Test fun specType1Test1() {
        specTest(GeneratorType.Aes128Ctr2048, ubyteArrayOf(
    ...
    @Test fun specType2Test1() {
        specTest(GeneratorType.Aes256Ctr2048, ubyteArrayOf(
                     0x00U, 0x01U, 0x02U, 0x03U, 0x04U, 0x05U, 0x06U, 0x07U,
                     0x08U, 0x09U, 0x0aU, 0x0bU, 0x0cU, 0x0dU, 0x0eU, 0x0fU,
                     0x10U, 0x11U, 0x12U, 0x13U, 0x14U, 0x15U, 0x16U, 0x17U,
